    ...
    >
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex gap-4">
          <a href="https://www.instagram.com/sapna_studioo" target="_blank" className="text-white text-xl hover:text-gold transition-colors"><FaInstagram /></a>
          <a href="https://wa.me/" className="text-white text-xl hover:text-green-400 transition-colors"><FaWhatsapp /></a>
        </div>

        <div className="md:hidden z-50 text-white text-2xl cursor-pointer" onClick={() => setIsOpen(!isOpen)}>
